 ...
 * 1) Set a break point in LaravelMaxGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class LaravelMaxGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("laravel-max") // use this codegen library
              ...
              .setOutputDir("out/laravel-max"); // output directory
