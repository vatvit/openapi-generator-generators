...
public class LaravelMaxGenerator extends AbstractPhpCodegen implements CodegenConfig {
  ...
  private String generateRoutesContent() {
    ...
    sb.append(" *         \\").append(apiPackage).append("\\Http\\Middleware\\AuthenticateBearerHttpAuthentication::class,\n");
    sb.append(" *     ]);\n");
    sb.append(" * })\n");
    sb.append(" * ```\n");
    sb.append(" *\n");
    ...
    sb.append("    if (class_exists(\\").append(apiPackage).append("\\Security\\SecurityValidator::class)) {\n");
    sb.append("        try {\n");
    sb.append("            \\").append(apiPackage).append("\\Security\\SecurityValidator::validateMiddleware($router);\n");
